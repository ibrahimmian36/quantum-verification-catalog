...
*2 entries. Generated from [`data/entries/`](data/entries/) by [`scripts/render.py`](scripts/render.py); stars/dates refreshed weekly by CI.*
...
|---|---|---|---|---|---|
| [QuantumLib](entries/quantumlib.md) | Coq/Rocq | library | mathematics | active | A Coq library of linear algebra and other mathematics used as the foundation for the inQWIRE quantum developments. |
| [SQIR](entries/sqir.md) | Coq/Rocq | language | circuits, program semantics | active | A small quantum intermediate representation embedded in Coq, with semantics used to prove correctness of quantum circuits and of the VOQC optimizer. |
