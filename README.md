...
| [TensorRocq](entries/tensorrocq.md) | library | mathematics | 2026-09-15 | not attempted | — | A small tensor library for working with diagrammatic calculi within Rocq. |
...
| Name | Role | Verifies | Last activity | Build | Paper | Description |
|---|---|---|---|---|---|---|
| [PyZX](entries/pyzx.md) | verifier | circuits | 2026-09-17 | builds | [arXiv:1904.04735](https://arxiv.org/abs/1904.04735) | A Python library for quantum circuit rewriting and optimisation using the ZX-calculus, including equivalence checking by diagram rewriting. |
